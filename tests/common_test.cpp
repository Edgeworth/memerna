...
void InitTest(const std::string& data_dir) {
  ...
  mrna::t04p1 = mrna::md::t04::erg::Model::FromDir(mrna::erg::ModelPath(data_dir, "t04p1"));

  mrna::test_ems[last_test_ems_idx++] = mrna::t04p1;
  mrna::test_t04_ems[last_test_t04_ems_idx++] = mrna::t04p1;

#elif ENERGY_PRECISION == 2
  mrna::t04p2 = mrna::md::t04::erg::Model::FromDir(mrna::erg::ModelPath(data_dir, "t04p2"));
  mrna::t12p2 = mrna::md::t04::erg::Model::FromDir(mrna::erg::ModelPath(data_dir, "t12p2"));
  mrna::t22p2 = mrna::md::t22::erg::Model::FromDir(mrna::erg::ModelPath(data_dir, "t22p2"));
  ...
  for (int i = last_test_t04_ems_idx; i < mrna::NUM_TEST_MODELS; ++i)
    mrna::test_t04_ems[i] = mrna::md::t04::erg::Model::Random(i);

  for (int i = last_test_t22_ems_idx; i < mrna::NUM_TEST_MODELS; ++i)
    mrna::test_t22_ems[i] = mrna::md::t22::erg::Model::Random(i);
}
