...
class MfeAlgTest : public testing::TestWithParam<context_opt_t::TableAlg> {
 public:
  energy_t Mfe(const std::string& s) {
...
TEST_P(MfeAlgTest, T04) {
  ...
  EXPECT_EQ(
      -133, Mfe("AAAAACUAGCAUCUAGUGGGCUCCCGAUCGCCUCCUUCUCGUAUUACGUUAAUGCAACUCAAGUGAGCCCGU"));
...
INSTANTIATE_TEST_SUITE_P(FoldAlgTest, MfeAlgTest, testing::ValuesIn(context_opt_t::TABLE_ALGS));
