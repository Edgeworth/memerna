...
class Ctx {
 public:
  ...
  [[nodiscard]] FoldResult Fold(const Primary& r, erg::EnergyCfg cfg, const erg::PseudofreeCfg& pf,
      const trace::TraceCfg& trace_cfg) const;
  [[nodiscard]] std::vector<subopt::SuboptResult> SuboptIntoVector(const Primary& r,
      erg::EnergyCfg cfg, const erg::PseudofreeCfg& pf, subopt::SuboptCfg subopt_cfg) const;
  [[nodiscard]] int Subopt(const Primary& r, erg::EnergyCfg cfg, const erg::PseudofreeCfg& pf,
      const subopt::SuboptCallback& fn, subopt::SuboptCfg subopt_cfg) const;
  [[nodiscard]] pfn::PfnResult Pfn(
      const Primary& r, erg::EnergyCfg cfg, const erg::PseudofreeCfg& pf) const;
