...
std::vector<Expansion> SuboptSlowest::ComputeExt(int st, int en, int a) {
...
std::vector<Expansion> SuboptSlowest::ComputePairedOrNoStack(int st, int en, bool is_nostack) {
  const auto stb = r[st];
  const auto st1b = r[st + 1];
...
std::vector<Expansion> SuboptSlowest::ComputeUnpaired(int st, int en, int a) {
  const auto stb = r[st];
  const auto st1b = r[st + 1];
...
std::vector<Expansion> SuboptSlowest::ComputePenultimate(int st, int en, int length) {
