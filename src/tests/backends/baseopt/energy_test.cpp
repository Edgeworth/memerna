...
class EnergyTestBaseOpt : public testing::TestWithParam<int> {
 public:
...
INSTANTIATE_TEST_SUITE_P(EnergyModelTests, EnergyTestBaseOpt, testing::Range(0, NUM_TEST_MODELS));

#if ENERGY_PRECISION == 1

TEST(EnergyTestBaseOpt, T04) {
  auto m = baseopt_t04;
...
INSTANTIATE_TEST_SUITE_P(CtdsTest, CtdsTestBaseOpt,
