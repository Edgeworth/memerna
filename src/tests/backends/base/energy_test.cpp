...
TEST_P(EnergyTestBase, NNDBHairpinLoopExamples) {
  ...
  {
    const Precomp pc(
        Primary(std::get<Primary>(kNNDBHairpin1)), m, erg::EnergyCfg{}, erg::PseudofreeCfg{});
    EXPECT_EQ(m->au_penalty + m->terminal[A][A][A][U] + m->HairpinInitiation(6), pc.Hairpin(3, 10));
  }

  {
    const Precomp pc(
        Primary(std::get<Primary>(kNNDBHairpin2)), m, erg::EnergyCfg{}, erg::PseudofreeCfg{});
  ...
  if (m->hairpin.contains("CCGAGG")) {
    const Precomp pc(
        Primary(std::get<Primary>(kNNDBHairpin3)), m, erg::EnergyCfg{}, erg::PseudofreeCfg{});
    EXPECT_EQ(m->hairpin["CCGAGG"], pc.Hairpin(3, 8));
  }

  {
    const Precomp pc(
        Primary(std::get<Primary>(kNNDBHairpin4)), m, erg::EnergyCfg{}, erg::PseudofreeCfg{});
  ...
  {
    const Precomp pc(
        Primary(std::get<Primary>(kNNDBHairpin5)), m, erg::EnergyCfg{}, erg::PseudofreeCfg{});
...
TEST(EnergyTestBase, T04) {
  ...
  const Precomp pc(Primary::FromSeq("GGGGAAACCCC"), m, erg::EnergyCfg{}, erg::PseudofreeCfg{});
