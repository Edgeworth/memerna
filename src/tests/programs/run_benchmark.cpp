...
DEFINE_SUBOPT_BENCH(base_t04, DEBUG, ITERATIVE, PERSISTENT);
DEFINE_PARTITION_BENCH(base_t04, DEBUG, OPT);

DEFINE_MFE_BENCH(baseopt_t04, DEBUG, SPARSE_OPT);
DEFINE_SUBOPT_BENCH(baseopt_t04, DEBUG, ITERATIVE, PERSISTENT);
DEFINE_PARTITION_BENCH(baseopt_t04, DEBUG, OPT);

DEFINE_MFE_BENCH(stack_t04, DEBUG);
DEFINE_SUBOPT_BENCH(stack_t04, ITERATIVE, PERSISTENT);
