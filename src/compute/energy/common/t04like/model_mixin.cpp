...
Energy T04ModelMixin::SubEnergyInternal(const Primary& r, const Secondary& s, int st, int en,
...
EnergyResult T04ModelMixin::SubEnergy(const Primary& r, const Secondary& s, const Ctds* given_ctd,
    int st, int en, bool build_structure) const {
...
EnergyResult T04ModelMixin::TotalEnergy(
