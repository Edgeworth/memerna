...
// Basic MFE folding.
DpArray MfeSlowest(const Primary& r, const erg::t04::Model::Ptr& em);

// Basic MFE folding.
DpArray MfeSlow(const Primary& r, const erg::t04::Model::Ptr& em);

// Sparse folding.
DpArray MfeFastest(const Primary& r, const erg::t04::Model::Ptr& em);
...
ExtArray MfeExterior(const Primary& r, const T& em, const DpArray& dp) {
